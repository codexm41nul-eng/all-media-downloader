...
const RESULT_MENU = Markup.inlineKeyboard([
  ...
  [Markup.button.callback('Delete',    'result_clear')],
]);
...
*Auto Detect Mode*
1\\. Tap *Auto Detect Mode*, then press *ON*
